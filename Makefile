##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.13.0-B3] date: [Sat May 01 11:43:39 CST 2021]
##########################################################################################################################
...
C_SOURCES =  \
$(wildcard Core/Src/*.c)\
$(wildcard Core/Src/devices/*.c) \
$(wildcard Core/Src/fonts/*.c)\
$(wildcard Core/Src/images/*.c)\
$(wildcard Core/Src/interface/*.c)\
$(wildcard Core/Src/misc/*.c)\
